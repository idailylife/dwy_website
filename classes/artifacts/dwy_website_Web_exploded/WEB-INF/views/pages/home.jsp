...
<div class="catproject content">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                <img src="img/main-intro.png" alt="The project of the day" class="img-responsive"/>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <a href="services.html" title="免费"><img src="img/digital/free.png" class="specialty img-circle img-center"></a>
                        <div class="caption">
                  ...
                  " data-toggle="tooltip" data-placement="bottom"><strong>免费</strong></a></h3>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <a href="services.html" title="精准"><img src="img/digital/precise.png" class="specialty img-circle img-center"></a>
                        <div class="caption">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <a href="services.html" title="可靠"><img src="img/digital/reliable.png" class="specialty img-circle img-center"></a>
                        <div class="caption">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-4">
                        <a href="services.html" title="安全"><img src="img/digital/1.png" class="specialty img-circle img-center"></a>
                        <div class="caption">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <a href="services.html" title="简单"><img src="img/digital/easy.png" class="specialty img-circle img-center"></a>
                        <div class="caption">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <a href="services.html" title="稳定"><img src="img/digital/stable.png" class="specialty img-circle img-center"></a>
                        <div class="caption">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 text-vertical-align">
                <div class="row">
                    <div class="col-lg-3">
                        <img src="img/weixin.png" class="smalllogo"/>
                    </div>
                    <div class="col-lg-3">
                        <img src="img/android.png" class="smalllogo"/>
                    </div>
                    <div class="col-lg-3">
                        <img src="img/windows.png" class="smalllogo"/>
                    </div>
                    <div class="col-lg-3">
                        <img src="img/apple.png" class="smalllogo"/>
                    </div>
                </div>
            </div>
        </div>
